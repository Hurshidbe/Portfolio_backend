...
export class CreateProfileDto {
  @ApiProperty({type :'string', description : 'to`liq ismi', example :'eshmatov toshman'})
  @IsString()
  full_name: string;
  ...
  @ApiProperty({type:'string', description : 'telegram url, url bolishi shart'})
  @IsUrl()
  @IsOptional()
  telegram?: string;

  @ApiProperty({type:'string', description : 'linkedin url, url bolishi shart'})
  @IsUrl()
  @IsOptional()
  linkedin?: string;

  @ApiProperty({description : `cv/resume  , formatlar : pdf/word/doc/jpg/png...`})
  @IsString()
  @IsOptional()
  @IsUrl()
  cv?: string;
